  ...
  <div class="row mb-4">
    <div class="col-12">      <div class="d-flex align-items-center justify-content-between">
        <div>
          ...
          @if(isset($total_count) && isset($displayed_count))
          <p class="text-muted mb-0 mt-2" style="font-size: 0.9rem;">
            ...
            @if($displayed_count < $total_count)
              <a href="?max=50" class="ms-2" style="color: #38ef7d;">Показать 50</a> |
              <a href="?max=100" style="color: #38ef7d;">100</a> |
              <a href="?max=500" style="color: #38ef7d;">Все</a>
            @endif
          </p>
          @endif
        </div>
